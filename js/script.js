...
function submitForm() {
  ...
  window.location.href = `mailto:lssub24@gmail.com?subject=Avis&body=Je m'appelle: ${name}%0AVous pouvez me contacter sur cette adresse mail : ${email}%0ACommentaire: ${comment}`;
